...
# Parsing + Configuration Script – T0006115 - Rev. A

This **Parsing + Configuration** script is designed for the **T0006115** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – T0006115 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **T0006115** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
